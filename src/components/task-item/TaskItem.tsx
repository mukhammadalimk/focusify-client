...
const TaskItem = ({
  ...
  return (
    <Link
      href="/tasks/1"
      className="w-full h-max rounded-[8px] border border-[#EEEEEE] dark:border-[#35383F] relative overflow-hidden cursor-pointer transition-all transform active:scale-[0.98] will-change-transform bg-white dark:bg-[#1F222A]"
    >
