...
const AddModal = ({ isModalOpen, onClose }: AddModalProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-[185px] h-[202px] rounded-xl z-55 absolute right-5 bottom-[150px] py-5 px-6 will-change-transform"
      ...
      >
        ...
        <div className="border-b border-[#EEEEEE] dark:border-[#35383F] flex gap-4 items-center pb-4 cursor-pointer z-10">
